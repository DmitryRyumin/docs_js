...
const createWindow = exports.createWindow = () => {
    let x, y; // Координаты окна

    /**
     * Получение окна приложения, которое в данный момент активно
     */
    const currentWindow = BrowserWindow.getFocusedWindow();

    /**
     * Окно приложение было создано
     */
    if (currentWindow) {
        /**
    ...
    let win = new BrowserWindow({
        ...
        x: x, // Позиция окна по X
        y: y, // Позиция окна по Y
        webPreferences: {
...
/**
 * Открытие и чтение файла, который был выбран через диалоговое окно
 * 
